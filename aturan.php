...
<div align="center">
		<a href="form_tambah_aturan.php">
			<button class="btn"  style="background-color: #66BB6A">+ Tambah Aturan Baru</button>
		</a>
	</div>
  <caption>Data Aturan</caption>
  <br>
  <thead>
    <tr>
      <th>Aturan</th>
    ...
    <?php 
			...
			while($data = $query->fetch(PDO::FETCH_ASSOC)) { ?>
				<tr>
					...
					<td >
						<a href="form_edit_aturan.php?id=<?php echo $data['id']; ?>"><button class="btn" style="background-color: #039BE5">Edit</button></a> 
						<a href="proses_hapus_aturan.php?id=<?php echo $data['id']; ?>" onclick="return confirm('Yakin hapus data?')"><button class="btn" style="background-color: #00B8D4">Hapus</button></a>					
					</td>
				</tr> <?php
			} ?>
    </tbody>
