...
<body>
    ...
    <div class="login-page">
        <div class="form">
        <td align="center"><?php echo "<img src='images/logo.jpg' width='150' height='70' />";?></td>
        <br></br>
            <form action="" method="post">
                <input type="text" name="username" placeholder="Username" required/>
                <input type="password" name="password" placeholder="Password" required/>
                <button name="login">login</button>
                <p class="message">Belum terdaftar? <a href="register.php">Buat akun</a></p>
                <h5>Username : Kolilik</h5>
                <h5>Password : Kolilik</h5>
            </form>
        </div>
    </div>
